    ...
    <div class="md:flex md:items-center">
        ...
        <div class="md:w-1/2 p-10 bg-white rounded-lg shadow-xl mt-10 md:mt-0">
            <form action="{{ route('posts.store') }}" method="POST" novalidate>
                ...
                <input type="submit" value="Publicar" class="bg-purple-500 hover:bg-purple-800 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg">
            </form>
        </div>
    </div>
@endsection