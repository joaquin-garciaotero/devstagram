...
@section('contenido')
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        <div class="md:w-6/12 p-5">
            <img src="{{ asset('img/registrar.jpg') }}" alt="Imagen registro de usuarios" class="rounded-xl shadow-lg">
        </div>
        <div class="md:w-4/12 bg-white p-6 shadow-xl rounded-xl">
            <form action="{{ route('register') }}" method="POST" novalidate>
                ...
                <input type="submit" value="Crear Cuenta" class="bg-purple-500 hover:bg-purple-800 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg">
            </form>
        </div>
    </div>
@endsection